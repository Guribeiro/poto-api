...
class UserTokensRepository implements IUserTokensRepository {
  ...
  public async create({ user_id, refresh_token, expires_date }: ICreateUserTokenDTO): Promise<UserTokens> {
  ...
  public async findOneByUserIdAndToken(user_id: string, token: string): Promise<UserTokens | null> {
